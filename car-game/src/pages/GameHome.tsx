...
const GameHome: React.FC = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gray-900 py-8 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-1 bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            <button
              ...
              className="mt-6 w-full flex items-center justify-center px-8 py-4 text-xl font-bold rounded-full bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-500 hover:to-pink-500 transform hover:scale-105 transition-all duration-300 shadow-lg"
            >
                ...
                leaderboard.map((player) => (
                  <div
                    ...
                    className={`flex items-center justify-between p-4 rounded-lg transition-all ${
                      player.rank <= 3 ? 'bg-gradient-to-r from-gray-700 to-gray-600 shadow-md' : 'bg-gray-750 hover:bg-gray-700'
                    }`}
                  >
